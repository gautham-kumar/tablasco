...
public class TableAdapters
{
     ...
     */
    public static ComparableTable withRows(ComparableTable delegate, IntObjectPredicate<ComparableTable> rowFilter)
    {
     ...
     * @return the adapted table
     */
    public static ComparableTable withColumns(ComparableTable delegate, Predicate<String> columnFilter)
    {
