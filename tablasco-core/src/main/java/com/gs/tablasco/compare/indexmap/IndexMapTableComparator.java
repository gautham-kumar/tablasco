...
public class IndexMapTableComparator implements SingleTableComparator
{
    ...
    public ResultTable compare(ComparableTable rhsData, ComparableTable lhsData)
    {
        if (rhsData == null)
        {
            return new ResultTable(new boolean[lhsData.getColumnCount()], toListOfRows(lhsData,  new Function2<String, Object, ResultCell>()
            {
                @Override
        ...
        if (lhsData == null)
        {
            return new ResultTable(new boolean[rhsData.getColumnCount()], toListOfRows(rhsData, new Function2<String, Object, ResultCell>()
            {
                @Override
                public ResultCell value(String columnName, Object value)
                {
