...
public class HideMatchedTablesTest
{
    ...
    {
        final VerifiableTable matchTable = new ListVerifiableTable("test", Arrays.<Object>asList("Col"), Arrays.<List<Object>>asList(Arrays.<Object>asList("A")));
        final VerifiableTable outOfOrderTableExpected = new ListVerifiableTable("test", Arrays.<Object>asList("Col 1", "Col 2"), Arrays.<List<Object>>asList(Arrays.<Object>asList("A", "B")));
        final VerifiableTable outOfOrderTableActual = new ListVerifiableTable("test", Arrays.<Object>asList("Col 2", "Col 1"), Arrays.<List<Object>>asList(Arrays.<Object>asList("B", "A")));
        final VerifiableTable breakTableExpected = new ListVerifiableTable("test", Arrays.<Object>asList("Col"), Arrays.<List<Object>>asList(Arrays.<Object>asList("A")));
        final VerifiableTable breakTableActual = new ListVerifiableTable("test", Arrays.<Object>asList("Col"), Arrays.<List<Object>>asList(Arrays.<Object>asList("B")));
